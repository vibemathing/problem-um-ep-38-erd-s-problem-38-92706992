...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-38-erd-s-problem-38-92706992-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-38"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-38-erd-s-problem-38-92706992-v1",
      "problem_contract_sha256": "80ff85b544eb7c9e370e763b13c05067a90d34b6f31fca4e638c6ad1fe041b29",
      "problem_id": "problem:um-ep-38-erd-s-problem-38-92706992",
      "route_id": "route:um-ep-38-erd-s-problem-38-92706992-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-38-erd-s-problem-38-92706992-source-fidelity-01",
      "graph_id": "graph:um-ep-38-erd-s-problem-38-92706992-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-38-erd-s-problem-38-92706992-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-38-erd-s-problem-38-92706992-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Does there exist $B\\subset\\mathbb{N}$ which is not an additive basis, but is such that for every set $A\\subseteq\\mathbb{N}$ of Schnirelmann density $\\alpha$ and every $N$ there exists $b\\in B$ such that $ \\lvert (A\\cup (A+b))\\cap \\{1,\\ldots,N\\}\\rvert\\geq (\\alpha+f(\\alpha))N $ where $f(\\alpha)>0$ for $0<\\alpha <1 $? The Schnirelmann density is defined by $ d_s(A) = \\inf_{N\\geq 1}\\frac{\\lvert A\\cap\\{1,\\ldots,N\\}\\rvert}{N}. $"
          },
          "statement_sha256": "5ceb603bea1c1587a71f95a682b266a5b4b453d526732ede387bd23fafd6f086"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-38-erd-s-problem-38-92706992-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-38-erd-s-problem-38-92706992-root",
      "route_id": "route:um-ep-38-erd-s-problem-38-92706992-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-38-21021d1b865a",
        "url": "https://www.unsolvedmath.com/problems/EP-38"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
